...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/$(SDL_PATH)/include $(LOCAL_PATH)/$(SDLIMAGE_PATH) $(LOCAL_PATH)/$(SDLMIXER_PATH)/include $(LOCAL_PATH)/$(SDLTTF_PATH) $(LOCAL_PATH)/$(APP_PATH) $(LOCAL_PATH)/$(COMPGFX_PATH) $(LOCAL_PATH)/$(GAMEGFX_PATH)
